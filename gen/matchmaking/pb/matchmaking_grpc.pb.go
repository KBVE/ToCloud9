...
const (
	...
	MatchmakingService_GetLFGStatus_FullMethodName                   = "/v1.MatchmakingService/GetLFGStatus"
)
...
type MatchmakingServiceClient interface {
	...
	// Dungeon finder. The queue is ephemeral and lives only in this process:
	// every start gets a new instanceID, and a caller that sees it change
	// replays JoinLFG with the original queuedAtUnixMilli. Joins are idempotent
	// by requestID, so a replay never double-queues.
	...
	GetLFGStatus(ctx context.Context, in *GetLFGStatusRequest, opts ...grpc.CallOption) (*GetLFGStatusResponse, error)
}
...
func (c *matchmakingServiceClient) GetLFGStatus(ctx context.Context, in *GetLFGStatusRequest, opts ...grpc.CallOption) (*GetLFGStatusResponse, error) {
	out := new(GetLFGStatusResponse)
	err := c.cc.Invoke(ctx, MatchmakingService_GetLFGStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MatchmakingServiceServer interface {
	...
	GetLFGStatus(context.Context, *GetLFGStatusRequest) (*GetLFGStatusResponse, error)
...
func (UnimplementedMatchmakingServiceServer) GetLFGStatus(context.Context, *GetLFGStatusRequest) (*GetLFGStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLFGStatus not implemented")
}
...
func _MatchmakingService_GetLFGStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLFGStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MatchmakingServiceServer).GetLFGStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MatchmakingService_GetLFGStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MatchmakingServiceServer).GetLFGStatus(ctx, req.(*GetLFGStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MatchmakingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLFGStatus",
			Handler:    _MatchmakingService_GetLFGStatus_Handler,
		},
	},
